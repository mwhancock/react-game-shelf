...
const GameCard = ({ game,isActive }) => {
  ...
  return (
    <>
      <div data-theme="light"  id={game[0].id} className={`carousel-item card ml-96 relative lg:card-side rounded-2xl bg-light-green shadow-xl mt-10 w-[73rem] h-[28rem] hidden`}>
        <figure><img className="w-[30rem] h-96 rounded-xl shadow-lg ml-16" src={game[0].image}  alt="box cover"/></figure>
        <div className="card-body">
          ...
          <div className="card-actions justify-end">
            <button className="absolute top-4 left-[43.2%] py-1.5 px-3.5 ml-2 rounded-md font-black text-3xl bg-accent text-btn-text hover:text-text-color  hover:bg-alt-accent border-none eas-in duration-150">+</button>
          </div>
        </div>
      </div>
    </>
